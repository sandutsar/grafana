...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.255.0 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/client_golang v1.20.4 // @grafana/alerting-squad-backend
