...
require (
	...
	github.com/getkin/kin-openapi v0.129.0 // @grafana/grafana-as-code
	...
	github.com/grafana/grafana-plugin-sdk-go v0.269.0 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/common v0.62.0 // @grafana/alerting-squad-backend
	...
	golang.org/x/sync v0.11.0 // @grafana/alerting-squad-backend
