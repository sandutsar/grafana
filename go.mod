...
require (
	...
	github.com/grafana/grafana-plugin-sdk-go v0.250.2 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/client_golang v1.20.3 // @grafana/alerting-squad-backend
