...
require (
	...
	github.com/getkin/kin-openapi v0.132.0 // @grafana/grafana-as-code
	...
	github.com/go-openapi/loads v0.22.0 // @grafana/alerting-squad-backend
	...
	github.com/googleapis/gax-go/v2 v2.14.0 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana-plugin-sdk-go v0.277.1 // @grafana/plugins-platform-backend
	...
	github.com/prometheus/common v0.63.0 // @grafana/alerting-squad-backend
